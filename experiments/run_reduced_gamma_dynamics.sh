#!/bin/bash
#SBATCH --job-name=reduced-gamma-dynamics
...
echo "Running reduced gamma dynamics experiment..."
python -u scripts/run_reduced_gamma_dynamics.py --no-show --device cuda
