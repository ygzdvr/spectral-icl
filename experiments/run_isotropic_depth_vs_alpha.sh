#!/bin/bash
#SBATCH --job-name=isotropic-depth-vs-alpha
...
echo "Running isotropic depth vs alpha sweep..."
python -u scripts/run_isotropic_depth_vs_alpha.py --no-show --device cuda
