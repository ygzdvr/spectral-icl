#!/bin/bash
#SBATCH --job-name=depth-scaling-nonrotate
...
echo "Running non-rotated depth scaling sweep..."
python -u scripts/run_depth_scaling_nonrotate.py --no-show --device cuda